			...
			<el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
				...
				<el-table-column label="验证码" align="center">
					<template #default="scope">
						<el-image class="table-td-thumb" :src="scope.row.identifyCodePic" :z-index="10"
							:preview-src-list="[scope.row.identifyCodePic]" preview-teleported>
						</el-image>
					</template>
				</el-table-column>
...
import { fetchData, fetchBrokerList } from '../api/index';
...
const getBrokerList = () => {
	fetchBrokerList().then(res => {
		tableData.value = res.data.data.items;
		pageTotal.value = res.data.data.total || 20;
	})
}
getBrokerList();
